...
public class IncompleteDataDTO {
    ...
    public static String getToString() {
        return "foundCustomer: " + foundCustomer + " " + "foundCustomerLocation: " + foundCustomerLocation + " "
                ...
                + foundCustomerTypePhone + " " + "foundCustomerPhone: " + foundCustomerPhone + " " + "foundCustomerName: "
                + foundCustomerName + " " + "foundCustomerLastName: " + foundCustomerLastName + " " + "dataCustomerCity: "
                + dataCustomerCity + " " + "dataCustomerDept: " + dataCustomerDept + " " + "dataCustomerAddress: "
                + dataCustomerAddress + " " + "dataCustomerPhone: " + dataCustomerPhone + " " + "dataCustomerName: "
                + dataCustomerName + " " + "dataCustomerLastName: " + dataCustomerLastName + " " + "dataCustomerEmail: " + dataCustomerEmail
                + " dataCustomerTypePhone: " + dataCustomerTypePhone;
    }
